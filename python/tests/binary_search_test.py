...
# from algo_expert.binary_search import binarySearch
# import unittest
...
#         self.assertEqual(
#             binarySearch([0, 1, 21, 33, 45, 45, 61, 71, 72, 73], 72), 8
#         )

#     def test_case_6(self):
#         self.assertEqual(
#             binarySearch([0, 1, 21, 33, 45, 45, 61, 71, 72, 73], 73), 9
#         )
...
#         self.assertEqual(
#             binarySearch([0, 1, 21, 33, 45, 45, 61, 71, 72, 73, 355], 355), 10
#         )
